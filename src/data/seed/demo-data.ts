...
export const demoTasks: TaskTemplate[] = [
  ...
  { id: "task-math-challenge", name: "数学小挑战", icon: "🧩", description: "Complete today's math challenge", durationMinutes: 40, points: 20, taskType: "OFFLINE", active: true },
  { id: "task-chinese-poem", name: "语文古诗", icon: "📜", description: "Read and review today's poem", durationMinutes: 5, points: 5, taskType: "OFFLINE", active: true },
  { id: "task-chinese-vocab", name: "语文字词", icon: "✏️", description: "Complete Chinese character and vocabulary practice", durationMinutes: 15, points: 10, taskType: "OFFLINE", active: true },
  { id: "task-free-reading", name: "自由阅读", icon: "📖", description: "Choose a book and read freely", durationMinutes: 30, points: 15, taskType: "OFFLINE", active: true },
];
export const demoAssignments: TaskAssignment[] = [
  ...
  { id: "assignment-mon-math", childId: demoChild.id, taskTemplateId: "task-math-challenge", weekdays: [1] },
  ...
  { id: "assignment-mon-reading", childId: demoChild.id, taskTemplateId: "task-free-reading", weekdays: [1] },
];
